...
If you want to get started quickly, change these settings first:

<DescriptionList
    items={[
        {
            label: "Production URL",
            description: "Set the canonical origin used for metadata, the sitemap, the RSS feed, and generated URLs.",
        },
        {
            label: "Site name",
            description: "Set the brand name used in metadata, the footer, the RSS feed, and accessible labels.",
        },
        {
            label: "Description",
            description: "Write the site-wide summary used by the RSS feed and structured data.",
        },
        {
            label: "Author",
            description: "Add the person or organization shown in the footer and page information.",
        },
        {
            label: "Sharing image",
            description: "Replace the default social image and describe it with useful alternative text.",
        },
        {
            label: "Navigation",
            description: "Choose the internal and external links shown in the header and footer.",
        },
    ]}
/>
...
<Figure
    caption="The default 1200 × 630 social sharing image included with the starter."
    credit="Bryan Hogan"
...
- `icon` must match an icon in `src/components/Icons.ts`.
- `label` is the social network's accessible name.
- `href` is the full profile URL.
...
5. Header and footer links point to your pages and external links use `external: true`.
6. Unused social links and analytics are empty.
7. Your pages and posts also have their own titles and descriptions.
