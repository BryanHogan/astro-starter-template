...
- `public/` - Static assets copied unchanged (favicon, icons, default social image) plus deployment configuration (`_headers`); `robots.txt` is generated by `src/pages/robots.txt.ts`
